...
const portfolioData = ref({
  ...
  hero: {
    ...
    subtitle:
      "Passionné par la création d'expériences web innovantes, performantes et esthétiques, transformant les idées en réalité numérique.",
    cta: "Voir mes réalisations",
  },
  about: {
    greeting: "Bonjour ! Je suis Bilel.",
    description1:
      "Développeur web créatif et orienté résultats, fort d'une expérience significative dans la conception, le développement et la maintenance d'applications web robustes et conviviales.",
    description2:
      "J'aime transformer des idées complexes en solutions élégantes et efficaces, tout en explorant continuellement de nouvelles technologies pour offrir des produits de haute qualité.",
    imageUrl: "https://placehold.co/400x400/0ea5e9/ffffff?text=GS", // Utilisez votre photo
    altText: "Photo de Bilel Lefi",
    contactLinks: {
      linkedin: "https://www.linkedin.com/in/Bilelsta/", // Mettez vos liens
      github: "https://github.com/Bilelsta",
      email: "Bilellefi06@example.com",
    },
  },
  skills: [
  ...
  experiences: [
    {
      ...
      description:
        "Leadership technique sur des projets d'envergure, conception d'architectures logicielles, développement de fonctionnalités complexes et mentorat d'équipes.",
      logoUrl: "https://placehold.co/100x100/e2e8f0/4a5568?text=IS",
    },
    {
      ...
      description:
        "Participation active au cycle de vie complet du développement, de la conception à la mise en production. Développement d'API RESTful et d'interfaces utilisateur interactives et responsives.",
      logoUrl: "https://placehold.co/100x100/cbd5e1/475569?text=DCA",
    },
  ],
  projects: [
    {
      ...
      description:
        "Solution e-commerce complète avec gestion de produits, paniers, paiements sécurisés et tableau de bord administrateur.",
      imageUrl: "https://placehold.co/600x400/0ea5e9/ffffff?text=Projet+1",
      altText: "Aperçu Plateforme E-commerce",
      tech: ["Vue.js", "Pinia", "Node.js", "Stripe API"],
      liveUrl: "#",
      repoUrl: "#",
    },
    {
      ...
      description:
        "Outil collaboratif en mode SaaS pour la gestion de projets et de tâches, avec suivi en temps réel et notifications.",
      imageUrl: "https://placehold.co/600x400/10b981/ffffff?text=Projet+2",
      altText: "Aperçu Application SaaS",
      tech: ["Nuxt.js", "Supabase", "Tailwind CSS"],
      liveUrl: "#",
      repoUrl: "#",
    },
    {
      ...
      description:
        "Mon portfolio personnel, une vitrine dynamique de mes compétences, expériences et projets, conçu pour une UX optimale.",
      imageUrl: "https://placehold.co/600x400/f59e0b/ffffff?text=Projet+3",
      altText: "Aperçu Portfolio",
      tech: ["Vue.js", "VueUse", "Tailwind CSS"],
      liveUrl: "#",
      repoUrl: "#",
    },
  ],
  contact: {
    email: "Bilellefi06@example.com",
    linkedin: "https://www.linkedin.com/in/Bilellefi/",
    github: "https://github.com/Bilellefi",
...
const observerCallback = (entries) => {
  entries.forEach((entry) => {
    if (entry.isIntersecting) {
      ...
      if (
        entryRect.top < viewportHeight * 0.5 &&
        entryRect.bottom > viewportHeight * 0.25
      ) {
        // Ajusté pour mieux cibler
...
onMounted(() => {
  ...
  faScript.integrity =
    "sha512-u3fPA7V8qQmhBPNT5quvaXVa1mnnLSXUep5PS1qo5NRzHwG19aHmNJnj1Q8hpA/ikRenbpPCSFCLzgXCMNSGQA=="; // Ajout d'intégrité
...
<template>
  <div
    class="font-sans bg-slate-100 text-slate-800 selection:bg-sky-500 selection:text-white antialiased"
  >
    <MainNavbar
